...
9. After installation boot back into the UEFI/BIOS and select OpenCore as the primary boot option. You may need to select Windows to boot back into Windows.
